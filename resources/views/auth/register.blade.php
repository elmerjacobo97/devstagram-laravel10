        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-2xl m-4 overflow-hidden">
            <div class="flex flex-col lg:flex-row justify-between">
                ...
                <div class="flex-1 lg:mr-4">
                    <h1 class="text-3xl font-semibold mb-6 text-center lg:text-left">Registro</h1>
                    <form>
                        <div class="mb-4">
                        ...
                        <button type="submit" class="bg-blue-500 text-white p-2 w-full rounded-md hover:bg-blue-400">Register</button>
                    </form>
                </div>

                <!-- Image -->
                <div class="flex-1 lg:ml-4 bg-cover bg-center hidden lg:block" style="background-image: url('{{ asset('images/register.jpg') }}')"></div>
            </div>
        </div>
    </div>
@endsection
